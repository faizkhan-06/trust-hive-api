...
import { badRequest, notFound, okResponse, serverError } from "../../libs/Response";
...
const CreateReview = async(req: Request, res: Response) => {
  try {
    ...
    const {rating, review_text, slug} = req.body;

    if(rating === undefined || !review_text || !slug) return badRequest(res, "Please provide rating, review text and slug");
